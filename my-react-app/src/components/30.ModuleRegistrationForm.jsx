    ...
    return (
        <div className="component-card">
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            ...
            <input  type='text' required name="name" placeholder="Module Name" value={formData.name} onChange={handleChange} style={{ padding: '10px', borderRadius: '5px' }} />
            <input  type='text' required name="code" placeholder="Module Code" value={formData.code} onChange={handleChange} style={{ padding: '10px', borderRadius: '5px' }} />
            ...
            <input  type='text' required name="credits" placeholder="Credits" value={formData.credits} onChange={handleChange} style={{ padding: '10px', borderRadius: '5px' }} />
